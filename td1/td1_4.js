...
// donc en en tient compte dans l'algo de tri
...
console.log(getNumberOfEven42([4, 2, 10, 20, 40, 87]));
console.log(getNumberOfEven42Alt1([4, 2, 10, 20, 40, 87]));
console.log(getNumberOfEven42Alt2([4, 2, 10, 20, 40, 87]));
console.log(getNumberOfEven42Alt3([4, 2, 10, 20, 40, 87]));
console.log(getNumberOfEven42Alt3([3]));
console.log(getNumberOfEven42Alt3([4]));
